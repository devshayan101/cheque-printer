    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Choose ChequeKart for HDFC Cheques?</h2>
          ...
          <ol className="space-y-4">
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">Choose "HDFC Bank" from the bank layout dropdown in ChequeKart.</p>
              </div>
            </li>
            <li className="flex gap-4">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <details className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              <summary className="font-semibold text-slate-900 cursor-pointer">Is ChequeKart compatible with all HDFC cheque formats?</summary>
              <p className="text-slate-600 mt-3">Yes, ChequeKart supports all standard HDFC cheque formats. If you have a custom cheque format, you can upload your cheque image for custom alignment.</p>
            </details>
            <details className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
