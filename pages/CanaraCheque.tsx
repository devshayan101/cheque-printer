        ...
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 tracking-tight">Why Choose ChequeKart for Canara Bank Cheques?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                            <h3 className="text-lg font-semibold text-gray-900 mb-2">Perfect Canara Bank Format Alignment</h3>
                            <p className="text-gray-600">Our software is specifically calibrated for Canara Bank cheque dimensions and field positions, ensuring every cheque prints correctly on the first try.</p>
                        </div>
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 tracking-tight">How to Print a Canara Bank Cheque</h2>
                    <ol className="space-y-4">
                        <li className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Select Canara Bank</h3>
                                <p className="text-gray-600">Choose "Canara Bank" from the bank layout dropdown in ChequeKart.</p>
                            </div>
                        </li>
                        <li className="flex gap-4">
                        ...
                        <li className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Print on Canara Bank Cheque Paper</h3>
                                <p className="text-gray-600">Load your Canara Bank cheque paper and click "Print Cheque". The software handles all alignment automatically.</p>
                            </div>
                        </li>
                    </ol>
                </section>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 tracking-tight">Canara Bank Cheque Specifications</h2>
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-4">
                        <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                            <summary className="font-semibold text-gray-900 cursor-pointer">Is ChequeKart compatible with all Canara Bank cheque formats?</summary>
                            <p className="text-gray-600 mt-3">Yes, ChequeKart supports all standard Canara Bank cheque formats. If you have a custom cheque format, you can upload your cheque image for custom alignment.</p>
                        </details>
                        <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                            <summary className="font-semibold text-gray-900 cursor-pointer">Can I adjust the field positions on my Canara Bank cheque?</summary>
