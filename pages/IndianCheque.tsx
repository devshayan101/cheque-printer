        ...
        <div className="min-h-screen bg-slate-50 text-slate-900">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Choose ChequeKart for Indian Bank Cheques?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                            <h3 className="text-lg font-semibold text-slate-900 mb-2">Perfect Indian Bank Format Alignment</h3>
                            <p className="text-slate-600">Our software is specifically calibrated for Indian Bank cheque dimensions and field positions, ensuring every cheque prints correctly on the first try.</p>
                        </div>
                        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-slate-900 mb-6">How to Print an Indian Bank Cheque</h2>
                    <ol className="space-y-4">
                        <li className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-slate-900">Select Indian Bank</h3>
                                <p className="text-slate-600">Choose "Indian Bank" from the bank layout dropdown in ChequeKart.</p>
                            </div>
                        </li>
                        <li className="flex gap-4">
                        ...
                        <li className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-slate-900">Print on Indian Bank Cheque Paper</h3>
                                <p className="text-slate-600">Load your Indian Bank cheque paper and click "Print Cheque". The software handles all alignment automatically.</p>
                            </div>
                        </li>
                    </ol>
                </section>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-slate-900 mb-6">Indian Bank Cheque Specifications</h2>
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-4">
                        <details className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                            <summary className="font-semibold text-slate-900 cursor-pointer">Is ChequeKart compatible with all Indian Bank cheque formats?</summary>
                            <p className="text-slate-600 mt-3">Yes, ChequeKart supports all standard Indian Bank cheque formats. If you have a custom cheque format, you can upload your cheque image for custom alignment.</p>
                        </details>
                        <details className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                            <summary className="font-semibold text-slate-900 cursor-pointer">Can I adjust the field positions on my Indian Bank cheque?</summary>
